...
class RNBlockstackSdk: NSObject {
    ...
    @objc public func signIn(_ resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let config = self.config,
          let redirectUrl = NSURL(string: config["redirectUrl"] as! String),
      ...
      Blockstack.shared.signIn(redirectURI: redirectUrl as URL, appDomain: appDomain, manifestURI: manifestURI, scopes: [AuthScope(rawValue: scopes)!]) { authResult in
